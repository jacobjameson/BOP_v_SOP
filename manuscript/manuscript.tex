...
tests). We find statistically and economically significant positive
effects of assignment to a high batching physician on every outcome
(Table 3). Estimated coefficients are scaled by the difference in
leniency going from the ninetieth to tenth percentile in physician
leniency---equal to 11.6 pp---for interpretability. Assignment to a
physician in the top prescribing decile (relative to one in the bottom
decile) is associated with a 0.24 pp increase in the probability of
long-term prescription opioid use--- a 4.1 percent increase. The effect
on proxies for opioid-seeking behavior is 0.50 pp---a 3.4 percent
increase. Effects on development of opioid use disorder and on opioid
overdose mortality are 2.1 percent and 8.8 percent, respec- tively.
These findings highlight the substantial role ED physicians can play in
putting patients on a path of long-term opioid use and dependence.
